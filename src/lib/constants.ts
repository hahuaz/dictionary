...
export const VIEW_DIR = path.join(process.cwd(), "src", "admin", "view");
export const ASSET_DICTIONARY_DIR = path.join("D:", "assets", "dictionary");
export const DESKTOP_DIR = path.join("C:", "Users", "hasan", "Desktop");
